...
export default function Login() {
    ...
    return (
        <div className="min-h-screen w-full bg-[#0f172a] relative overflow-y-auto font-display">
            ...
            <div className="min-h-screen w-full flex items-center justify-center p-4 sm:p-6 lg:p-8 py-8">
                <div className="w-full max-w-lg relative z-10 animate-fade-in">
                    <div className="bg-surface-dark/50 backdrop-blur-xl border border-white/10 rounded-2xl p-6 sm:p-8 shadow-2xl">
                        <div className="text-center mb-6 sm:mb-8">
                            <div className="w-14 h-14 sm:w-16 sm:h-16 bg-primary rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg shadow-primary/30">
                                <span className="material-symbols-outlined text-2xl sm:text-3xl text-white">account_balance_wallet</span>
                            </div>
                            <h1 className="text-xl sm:text-2xl font-bold text-white mb-2">Welcome Back</h1>
                            <p className="text-sm sm:text-base text-slate-400">Sign in to manage your family finance</p>
                        </div>

                        {/* Success Message */}
                        {showSuccessMessage && (
                            <div className="mb-6 p-4 bg-emerald-500/10 border border-emerald-500/30 rounded-xl animate-in fade-in slide-in-from-top-2 duration-300">
                                <div className="flex items-start gap-3">
                                    ...
                                    <div className="flex-1">
                                        <h3 className="text-sm font-bold text-emerald-400 mb-1">Account Created Successfully!</h3>
                                        <p className="text-xs text-emerald-300/80">Your account has been created. Please sign in with your credentials.</p>
                                    </div>
                                    <button
